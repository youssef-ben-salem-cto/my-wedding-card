...
/**
 * Subtle flowers placed *inside* the invitation card so they drift behind the text.
 */
const innerFlowers = [
  { top: '18%', left: '4%', size: 'w-4 h-4 sm:w-5 sm:h-5', color: 'text-[#d4af37]', delay: '0.6s', peakOpacity: 0.22, pulseDuration: 3.4 },
  { top: '30%', right: '5%', size: 'w-3 h-3 sm:w-4 sm:h-4', color: 'text-[#c59a3f]', delay: '0.9s', peakOpacity: 0.18, pulseDuration: 4.2 },
  { top: '45%', left: '3%', size: 'w-4 h-4 sm:w-5 sm:h-5', color: 'text-[#d4af37]', delay: '1.2s', peakOpacity: 0.2, pulseDuration: 3.8 },
  { top: '60%', right: '4%', size: 'w-3 h-3 sm:w-4 sm:h-4', color: 'text-[#c59a3f]', delay: '1.5s', peakOpacity: 0.16, pulseDuration: 5.1 },
  { top: '75%', left: '5%', size: 'w-4 h-4 sm:w-5 sm:h-5', color: 'text-[#d4af37]', delay: '1.8s', peakOpacity: 0.22, pulseDuration: 4.5 },
  { top: '88%', right: '4%', size: 'w-3 h-3 sm:w-4 sm:h-4', color: 'text-[#c59a3f]', delay: '2.1s', peakOpacity: 0.18, pulseDuration: 3.6 },
];
    ...
    >
      ...
      <div className="relative w-full max-w-xl mx-auto">
        ...
        >
          ...
          <div className="absolute inset-3 border border-[#d4af37]/30 rounded-[1.25rem] pointer-events-none z-10" />
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none z-0" aria-hidden="true">
            {innerFlowers.map((flower, index) => {
              ...
              return (
                <motion.div
                  key={index}
                  className={`absolute ${flower.size} ${flower.color}`}
                  style={{
                    ...positionStyle,
          ...
          {/* Card content above inner flowers */}
